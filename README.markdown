Title: Orange Commands v1.3.6-dev for Adobe Fireworks
CSS: style.css

# Orange Commands v1.3.6-dev for Adobe Fireworks
...
- Download Orange Commands [for Fireworks CS3](http://sofanaranja.com/dl/OrangeCommands_1.3.6-dev_CS3.zip) or [for Fireworks CS4](http://sofanaranja.com/dl/OrangeCommands_1.3.6-dev_CS4.zip)
- Expand the ZIP.
...
- **All Pages as PNG 24** (Ctrl + Alt + Shift + X)
  ...
  Exports all pages as flattened (non editable) PNG files with a 24 bits color depth. The files are saved in a folder named YYYYMMDDHHMMSS (i.e: 20091028133619) inside the current folder, with the page names as the file names.
...
---
Orange Commands v1.3.6-dev — last updated Wed Oct 28 13:36:19 +0100 2009